...
export const maturityLevels: MaturityLevel[] = [
  {
    ...
    shortDescription:
      "Every business begins here. Activity is possible; consistency isn't. Success isn't a strategy document — it's narrowing a vague sense that AI matters down to the small number of specific conditions worth examining first.",
    borderClass: "border-slate-400",
    badgeClass: "bg-slate-100 text-slate-800 border-slate-300",
    numClass: "bg-slate-200 text-slate-800",
    bgGradientClass: "bg-gradient-to-br from-slate-50 to-gray-100",
    overview:
      "Every business begins here. Activity is possible; consistency isn't. This isn't revealed by how mature the business looks on paper — it's revealed by behavior: pull three senior leaders aside separately and ask which AI-influenced decisions matter most right now. At Initial, you get opportunity or competitive pressure, not a specific decision. Success here isn't a strategy document, a policy, or a training program. It's narrowing a vague sense that AI matters down to the small number of specific conditions worth examining first.",
    perspectives: {
      Strategy:
      ...
      Data:
        "Data is present but not yet a managed decision asset. Teams can't reliably say what data would be needed to support a given decision. The work here is narrow: identify the small set of data elements that matter most to the first decisions the business wants to improve.",
      People:
      ...
      Technology:
        "Technology hasn't formed into a real AI operating environment — tools get tested informally with no stable pattern of business use. There's no coherent system to depend on yet. The work is identifying where AI use should begin and what basic conditions need to exist first.",
    },
  },
  {
    number: 2,
  ...
  },
  {
    ...
    shortDescription:
      "Individual efforts work and can be defended on their own terms, but they don't generalize past the context that produced them. The business is productive in ways that don't add up — the constraint is the inability to stop work that isn't moving the business forward as a system.",
    borderClass: "border-indigo-400",
    badgeClass: "bg-indigo-100 text-indigo-800 border-indigo-200",
    numClass: "bg-indigo-100 text-indigo-800",
    bgGradientClass: "bg-gradient-to-br from-indigo-50 to-purple-50",
    overview:
      "Individual efforts work and can be defended on their own terms, but they don't generalize past the specific context that produced them. Teams can explain their own use cases but can't explain enterprise-level prioritization or trade-offs. The business is productive in ways that don't add up — success is opportunism, not architecture, and the constraint at this level is the inability to stop work that isn't actually moving the business forward as a system.",
    perspectives: {
      Strategy:
        "Individual teams can explain what they're improving and show measurable gains — but there's no shared logic for prioritizing across teams, so everything looks equally worth pursuing. The business is productive in ways that don't add up. The constraint is the inability to stop work.",
      Governance:
        "Governance exists in parts of the business — some decisions are well-controlled, others aren't, and similar decisions get handled differently across teams. The work here is extension: making consistent what's already working in one place and applying the same standard elsewhere.",
      Data:
      ...
      People:
        "Usage shows real value, but interpretation stays local — two experienced people can act on the same output differently and both believe they're right. The inconsistency hides because the business attributes it to case complexity instead of missing standards.",
      Technology:
  ...
  },
  {
    ...
    overview:
      "Structure exists and holds under normal conditions. The gap shows up specifically when something is contested, urgent, or the world changes underneath it. This is the level most self-assessments mistake for a finish line, because the documentation looks complete — roles, responsibilities, policies, training records. The real test isn't the paperwork. It's tracing a recent difficult decision end to end. If that trace depends on who was in the room, the business is still Formalizing no matter how thorough it looks on paper.",
    perspectives: {
      Strategy:
      ...
      Data:
        "Definitions are standardized and governed across the business — which creates a specific new blind spot. The system is stable under known conditions but can't tell a quality failure from representational drift: data that passes every check while no longer representing how the business actually operates. If the business can't explain that difference, it's still Formalizing.",
      People:
  ...
  },
  {
    ...
    perspectives: {
      ...
      Data:
        "Feedback loops are operational rather than theoretical. When a decision fails, the business can trace whether the cause was completeness, timeliness, relevance, or drift, and correct it in a way that improves future performance. The temptation at this Maturity Level is expanding faster than feedback can keep up.",
      People:
        "Interpretation is consistent and explainable. People understand why the guidance exists and apply it similarly across contexts, and when two people disagree, the business can explain why. The difficulty is sustaining that as the system reaches new users and new use cases.",
      Technology:
        "The system is designed to evolve — dependencies are understood and changes can be introduced without destabilizing decisions. The business can predict the impact of a change, execute it, and verify the outcome with minimal disruption. The failure to watch for is overextension: adding complexity faster than it can be governed.",
    },
  },
  {
    number: 6,
    slug: "leading",
    name: "Leading",
    tagline: "Improvement is built into how the business operates, not applied to it periodically.",
    shortDescription:
      "Improvement is built into how the business operates day to day, rather than something applied to it periodically. This isn't the final destination — it's the beginning of stewardship.",
    ...
    perspectives: {
      Strategy:
        "Strategy isn't separate from operations — it's the mechanism decisions improve through. The business anticipates where its approach will fail and adjusts before degradation shows up. The question shifts from whether the strategy is being followed to whether it's still correct.",
      Governance:
      ...
      Data:
        "Data strategy is tied directly to decision strategy — the business anticipates where current data will fall short before a new decision gets introduced, rather than waiting for the failure. The failure mode here is overextension: sophistication that isn't yet tied to any decision the business is actually trying to improve.",
      People:
