...
export const metadata: Metadata = {
  ...
  description:
    "Leading: improvement is built into how the business operates, not applied to it periodically. What this looks like across Strategy, Governance, Data, People, and Technology.",
  alternates: {
